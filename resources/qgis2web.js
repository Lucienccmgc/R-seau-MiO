...
map.getView().fit([334453.058712, 5475432.964368, 349430.107374, 5485312.409283], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Réseau de bus urbain MiO</h2>';
        return titleElement;
    })(),
